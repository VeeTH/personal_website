class SiteFooter extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
            ...
            <h3>Last updated November 12th, 2024</h3>
            <h3><a id="licensebox_btn" style="text-decoration: underline; cursor: pointer; user-select: none;">Copyright © 2024<!---2025--> VeeTHis</a></h3>

            <div id="licensebox" title="LicenseBox" style="display: none;">
              <p id="licensebox_txt">Loading copyright info...</p>
            </div>
    `;
  }
}
